...
module.exports = function (args) {
    ...
    let input, grammar, displayname, doTrace;
    ...
    switch (args[0]) {
        ...
        case "branch-fail":
            input = "ayaa";
            grammar = new (require("./branch-fail-grammar.js"))();
        ...
        case "parent":
            ...
            grammar = new (require("./parent-mode-grammar.js"))();
        ...
        case "universal":
            input = "xXXx";
            grammar = new (require("./universal-mode-grammar.js"))();
