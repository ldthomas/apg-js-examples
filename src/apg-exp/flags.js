...
// <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp">MDN</a>)
...
(function () {
    try {
        ...
        let grammar = 'rule = "abc" / "xyz"\n';
        let exp, flags, result, str;
        ...
        result = exp.exec(str);
        console.log(
            "         : With no flags, lastIndex is never repositioned. The same phrase is found over and over."
        );
        console.log("    flags: '" + exp.flags + "'");
        console.log("    input: '" + str + "'");
        console.log(
            "lastIndex: " + exp.lastIndex + ": index: " + result.index + ": result[0]: " + "'" + result[0] + "'"
        );
        result = exp.exec(str);
        console.log(
            "lastIndex: " + exp.lastIndex + ": index: " + result.index + ": result[0]: " + "'" + result[0] + "'"
        ...
        console.log();
        console.log(
            "         : With the 'y' flag, lastIndex is an anchor. The phrase must be found exactly at lastIndex."
        );
        console.log("    flags: '" + exp.flags + "'");
        console.log("    input: '" + str + "'");
        while (true) {
